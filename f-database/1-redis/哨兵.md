...
![async-slave](/study/imgs/async-copy.png)
...
![redis-cluster-split-brain.png](/study/imgs/redis-cluster-split-brain.png)
...
##### quorum 和 majority quorum 和 majority
